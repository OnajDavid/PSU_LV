...
test_preds = best_model.predict(train_ds)

train_labels = np.argmax(train_preds, axis=1)
test_labels = np.argmax(test_preds, axis=1)

train_accuracy = accuracy_score(validation_ds, train_labels)
test_accuracy = accuracy_score(validation_ds, test_labels)
...
plot_confusion_matrix(validation_ds, train_labels, "Matrica zabune - Trening skup")
plot_confusion_matrix(test_ds, test_labels, "Matrica zabune - Test skup")